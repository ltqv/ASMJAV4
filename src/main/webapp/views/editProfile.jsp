        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-4">
                ...
                <form action="${pageContext.request.contextPath}/editProfile" method="post">
                    <div class="mb-3">
                        <label class="form-label">Tên đăng nhập (Không thể đổi)</label>
                        <input type="text" class="form-control bg-light" value="${sessionScope.currentUser.id}" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control bg-light" 
                               value="${sessionScope.currentUser.admin ? 'Quản trị viên (Admin)' : 'Người dùng (User)'}" readonly>
                    </div>
